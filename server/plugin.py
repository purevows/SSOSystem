...
class ProductionConfig:
    ...
    SESSION_TYPE = "redis"
    SESSION_REDIS = redis.Redis(host="192.168.0.0", port=12500, password="password", db=0)
...
redis_conn_pool = redis.ConnectionPool(host="192.168.0.0", port=12500, password="password", db=0)
